...
`/opt/mitra-factory/system_prompt.md` — é o system prompt oficial da plataforma Mitra. Contém TUDO sobre o SDK, templates React, convenções de projeto, erros comuns, fluxo de auth, padrões de SF, deploy, testes. Sem ler isso, você vai errar decisões básicas que a plataforma já documentou.
