...
- **Banco da AF:** continua individualizado por instância. Mudanças nos prompts (back-end) não tocam o banco. Mudanças no `template/` (front-end) só afetam sistemas novos — sistemas existentes mantêm o template antigo já clonado em S3.
